    ...
    <div class="ed_dashboard_inner_tab">
        <div role="tabpanel">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation"><a class="active" href="#general" aria-controls="general" role="tab"
                        data-bs-toggle="tab">general</a>
                </li>
                <li role="presentation"><a href="#email" aria-controls="email" role="tab"
                        data-bs-toggle="tab">email</a></li>
                <li role="presentation"><a href="#visibility" aria-controls="visibility" role="tab"
                        data-bs-toggle="tab">profile visibility</a></li>
            </ul>
                ...
                <div role="tabpanel" class="tab-pane active" id="general">
                    <div class="ed_dashboard_inner_tab">
                        ...
                        <form class="ed_tabpersonal">
                            ...
                            <div class="form-group">
                                <p>Change Password <strong>(leave blank for no change)</strong>
                                </p>
                            </div>
                            <div class="form-group">
                            ...
                            <tbody>
                                <tr>
                                    <td>A member mentions you in an update using
                                        "@andrehouse123"</td>
                                    <td class="yes"><input type="radio" name="activity1" value="yes"
                                            checked="checked"></td>
