            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                    ...
                    <div class="ed_time_executor ed_toppadder40">
                        <ul>
                            <li><a href="{{ route('dashboard_enseignant.course_lesson') }}">Temps estimé pour la leçon</a>
                                <span>estimated time</span>
                            </li>
                            <li><a href="{{ route('dashboard_enseignant.course_lesson') }}">development overview</a> <span><i
                                        class="fa fa-check-circle-o"></i></span></li>
                            <li><a href="{{ route('dashboard_enseignant.course_lesson') }}">basic html</a> <span>Currently
                                    active</span></li>
                            <li><a href="{{ route('dashboard_enseignant.course_lesson') }}">Basic CSS</a> <span>Locked</span></li>
                            <li><a href="{{ route('dashboard_enseignant.course_lesson') }}">Advanced HTML + CSS</a> <span>Locked</span>
                            </li>
                            <li><a href="{{ route('dashboard_enseignant.course_lesson') }}">Javascript Beginners</a>
                                <span>Locked</span>
                            </li>
                        </ul>
                    </div>
