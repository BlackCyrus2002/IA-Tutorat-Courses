                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                    <div class="ed_dashboard_tab">
                        <div class="tab-content">
                            ...
                            @include('dashboard_enseignant.mes_cours')

                            @include('dashboard_enseignant.activite')

                            @include('dashboard_enseignant.notifications')

                            @include('dashboard_enseignant.profil')

                            @include('dashboard_enseignant.parametres')

                            @include('dashboard_enseignant.forums_tuteur')
