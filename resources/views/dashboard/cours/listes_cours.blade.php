            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 ed_bottompadder20">
                    ...
                    <div class="ed_item_description ed_most_recomended_data">
                        <h4><a href="course_single.html">Project Learning
                            </a><span>£25</span></h4>
                        <div class="row">
                            <div class="ed_rating">
                        ...
                        <p>Project-Based Learning is a flexible tool for framing
                            ...
                            tool for framing.</p>
                        <a href="course_single.html" class="ed_getinvolved">get
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 ed_bottompadder20">
                    ...
                    <div class="ed_item_description ed_most_recomended_data">
                        <h4><a href="course_single.html">Billing
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 ed_bottompadder20">
                    ...
                    <div class="ed_item_description ed_most_recomended_data">
                        <h4><a href="course_single.html">Girls On Rails
                            </a><span>£40</span></h4>
                        <div class="row">
                            <div class="ed_rating">
                                <div class="col-lg-6 col-md-7 col-sm-6 col-6">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 ed_bottompadder20">
                    ...
                    <div class="ed_item_description ed_most_recomended_data">
                        <h4><a href="course_single.html">programming
                            </a><span>£38</span></h4>
                        <div class="row">
                            <div class="ed_rating">
                                <div class="col-lg-6 col-md-7 col-sm-6 col-6">
