                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="ed_sidebar_wrapper">
                        <div class="ed_profile_img">
                            <img src="{{ $etudiant->imageUrl() ?? 'https://dummyimage.com/263x263/000/fff' }}" alt="Dashboard Image" />
                        </div>
                        <h3>andre house</h3>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="dashboard">
                                <div class="ed_dashboard_tab_info">
                                    ...
                                    <p style="text-align: left">Salut <strong> {{ $etudiant->nom . ' ' . $etudiant->prenoms }} </strong>, ici, vous devez voir et
                                        mettre à jour votre
                                        profil,
